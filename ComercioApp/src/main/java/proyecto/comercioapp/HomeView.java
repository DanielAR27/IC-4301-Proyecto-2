...
public class HomeView extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jMenuItem1.setText("Editar datos personales");
        jMenuItem1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                editUserMenuItemActionPerformed(evt);
            }
        });
        menuMomentaneo.add(jMenuItem1);
    ...
    private void eliminarCuenta() {
        boolean exito = DBMediator.deleteUsuario(usuarioID); // Método que debes implementar en DBMediator
    ...
    private void crearBotonesProductos() {
        ...
        for (int i = 0; i < 10; i++) {
            ...
            boton.addActionListener(e -> {
                showProductoInfo(botonPosition);
            });
