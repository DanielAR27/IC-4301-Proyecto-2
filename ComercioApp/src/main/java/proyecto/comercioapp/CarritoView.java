...
public class CarritoView extends javax.swing.JFrame {
    ...
    public CarritoView(int usuarioID){
        ...
        actualizarPanelesProductos(usuarioID, pagina);
    }
            ...
            .addGroup(innerPanelLayout.createSequentialGroup()
                ...
                .addGroup(innerPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(innerPanelLayout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addComponent(continuarButton, javax.swing.GroupLayout.PREFERRED_SIZE, 102, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(26, 26, 26))
                    .addGroup(innerPanelLayout.createSequentialGroup()
    ...
    private void continuarButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_continuarButtonActionPerformed
        ChooseDirection cd = new ChooseDirection(usuarioID);
        this.dispose();
        cd.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CarritoView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CarritoView().setVisible(true);
            }
        });
    }
    ...
    private void crearPanelesProductos() {
        ...
        for (int i = 0; i < 5; i++) {
            ...
            // Agregar un botón de eliminación al panel
            JButton eliminarButton = new JButton("-");
            eliminarButton.setFont(new java.awt.Font("Arial", java.awt.Font.BOLD, 18)); // Fuente más grande para que se vea bien
            eliminarButton.setBounds(anchoPanel - 50, 10, 40, 30); // Ajustar tamaño del botón y posición
            ...
            eliminarButton.addActionListener(e -> {
                borrarCarritoProducto(panelIndex);
            });
    ...
    private void actualizarPanelesProductos(int usuarioID, int numPagina) {
        int index = 0;
        productosPagina = DBMediator.getProductosDeUsuarioPorPagina(usuarioID, numPagina);
        int stillProducts = DBMediator.verificarProductosDeUsuarioPorPagina(usuarioID, numPagina + 1);
        ...
        if (numPagina == 0 && productosPagina.isEmpty()) {
            ...
            // Ocultar los paneles que no tienen datos
                    ...
                    switch(res){
                        case 0->{
                            JOptionPane.showMessageDialog(this,
                                    "Se ha eliminado exitosamente el producto del carrito.",
                                    "Notificación",
                            ...
                            JOptionPane.showMessageDialog(this,
                                    "No se ha podido eliminar el producto del  carrito, intente de nuevo más tarde.",
                                    "Advertencia",
                                    JOptionPane.WARNING_MESSAGE);
                            return;
                       }                    
