...
BEGIN
    BEGIN TRY
        ...
        -- Validar si el DescuentoID es válido
        ...
        BEGIN
            SET @Resultado = -2; -- Error: Nombre del producto inválido
            ROLLBACK TRANSACTION;
            RETURN;
        END
        ...
        BEGIN
            SET @Resultado = -2; -- Error: Porcentaje de descuento inválido
            ROLLBACK TRANSACTION;
            RETURN;
        END
        ...
        BEGIN
            SET @Resultado = -2; -- Error: Fechas inválidas
            ROLLBACK TRANSACTION;
            RETURN;
        END
